...
if analyze_button:
    ...
    with st.spinner("Running analysis, please wait..."):
        ...
        st.session_state.result_file_path = create_crew(stock_symbol)
...
st.markdown("---")
st.markdown('<p class="small-font">Created by Riki Jha | Data provided by Reddit and Yahoo Finance </p>', unsafe_allow_html=True)